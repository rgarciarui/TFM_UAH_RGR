...
def get_baselines(img_LR_pil, img_HR_pil):
    '''Obtiene `bicubic`, bicúbico afilado y líneas de base cercanas.'''
...
def tv_loss(x, beta = 0.5):
    '''Calcula la pérdida de TV para una imagen `x`.
        
    Args:
        x: image, torch.Variable of torch.Tensor
        beta: Leer https://arxiv.org/abs/1412.0035 (fig. 2) para ver el efecto de `beta`
    '''
